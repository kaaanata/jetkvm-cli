...
func Static() Catalog {
	definitions := []ToolDefinition{
		...
		writeTool("jetkvm_pointer_move", "input", EffectInput, false, "pointer_move_input", "action_batch_output", "pointer"),
		writeTool("jetkvm_pointer_double_click", "input", EffectInput, false, "pointer_double_click_input", "action_batch_output", "pointer"),
		writeTool("jetkvm_pointer_drag", "input", EffectInput, false, "pointer_drag_input", "action_batch_output", "pointer"),
		writeTool("jetkvm_pointer_scroll", "input", EffectInput, false, "pointer_scroll_input", "action_batch_output", "pointer"),
